                        ...
                        <div  class="card">
                            <div class="card-body">
                                ...
                                <form method="post" action="../Exportar">
                                    <input type="hidden" name="Valor" value="13">
                                    <input type="hidden" name="url" value="HistorialSolicitudesRecibidas">
                                    <input type="hidden" name="urlCompleta" value="./ReportesCliente/HistorialSolicitudesRecibidas.jsp">
