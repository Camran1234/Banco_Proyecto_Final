...
public class InfoGerente {
    public String obtenerDPIGerente(String codigo){
        try {  
            ...
            String comando = "SELECT * FROM GERENTE WHERE NoUsuario=?";
            PreparedStatement statement = null;
            statement = connection.prepareStatement(comando);
            statement.setString(1, codigo);
            ResultSet resultado = statement.executeQuery();
            if(resultado.next()){
                dpi = resultado.getString("DPI");
            }
    ...
    public ArrayList<ArrayList> InformacionBasica(){
        ...
        try {  
            ...
            Connection connection = new Conexion().CreateConnection();
            String comando = "SELECT * FROM GERENTE ORDER BY DPI";
            PreparedStatement statement = null;
            statement = connection.prepareStatement(comando);
            ResultSet resultado = statement.executeQuery();
