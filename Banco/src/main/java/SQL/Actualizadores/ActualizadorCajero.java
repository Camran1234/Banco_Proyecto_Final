 ...
 * @author camran1234
 */
public class ActualizadorCajero {
    ...
    public ActualizadorCajero(String nombre, String dpi, String direccion, String sexo, String turno, String codigoUsuario, String password, String password2) throws FormatException {
        if(dpi.length()!=13){                        
        ...
        this.turno = turno;
         try {
             ...
             Logger.getLogger(ActualizadorCajero.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public String subirArchivo() {
        try {
            ...
            String comando2 = "UPDATE CAJERO SET Nombre=?, Turno=?, Direccion=?, Sexo=? WHERE NoUsuario=?";
            ...
            //Subimos el archivo
            return "El cajero "+nombre+ " de dpi "+dpi+" se actualizo correctamente";    
