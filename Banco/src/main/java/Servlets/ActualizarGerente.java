...
import SQL.Actualizadores.ActualizadorGerente;
...
public class ActualizarGerente extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String mensaje = null;
        try {
                  mensaje = new ActualizadorGerente(nombre, dpi, direccion, sexo, turno, codigoUsuario, password, password2).subirArchivo();
