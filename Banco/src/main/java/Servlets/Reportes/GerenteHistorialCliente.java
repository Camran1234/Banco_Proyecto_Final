 ...
 * @author camran1234
 */
@WebServlet("/GerenteHistorialCliente")
public class GerenteHistorialCliente extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        response.sendRedirect("./ReportesGerente/HistorialTransaccionCliente.jsp");
    }
