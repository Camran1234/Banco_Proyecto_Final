 ...
 * @author camran1234
 */
@WebServlet("/ClienteSolicitudesEnviadas")
public class ClienteSolicitudesEnviadas extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
         ...
         try {
            ...
            request.getSession().setAttribute("transaccion", reportes.imprimirSolicitudesEnviadas(codigo));
            ...
            response.sendRedirect("./ReportesCliente/HistorialSolicitudesEnviadas.jsp");
