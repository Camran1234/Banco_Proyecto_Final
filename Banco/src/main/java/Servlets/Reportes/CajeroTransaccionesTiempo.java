...
import SQL.Reportes.ReportesCajero;
 ...
 * @author camran1234
 */
@WebServlet("/CajeroTransaccionesTiempo")
public class CajeroTransaccionesTiempo extends HttpServlet {
    ReportesCajero reporte = new ReportesCajero();
    /**
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<TransaccionModel> transacciones = reporte.imprimirTransaccionesPorIntervalo(codigo,fechaInicial, fechaFinal, horaInicial, horaFinal);
            request.getSession().setAttribute("transaccion", transacciones);
            ...
            response.sendRedirect("./ReportesCajero/TransaccionIntervaloTiempo.jsp");
