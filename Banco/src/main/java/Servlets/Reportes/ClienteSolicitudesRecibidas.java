 ...
 * @author camran1234
 */
@WebServlet("/ClienteSolicitudesRecibidas")
public class ClienteSolicitudesRecibidas extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.getSession().setAttribute("transaccion", reportes.imprimirSolicitudesRecibidas(codigo));
            ...
            response.sendRedirect("./ReportesCliente/HistorialSolicitudesRecibidas.jsp");
