<%-- 
    Document   : ClientesMayorDinero
    Created on : Nov 14, 2020, 6:40:32 AM
    Author     : camran1234
--%>
    ...
    <body>
                        ...
                        <div  class="card">
                            <div class="card-body">
                                <div class="card-title">
                                    <h2 class="text-center" id="text" >Clientes con Mayor Cantidad de Dinero</h2>
                                </div>
                                <hr>
                                <form method="post" action="../GerenteCuentasMasRicas">
        ...
        <table class="table table-borderless table-dark">
            <tr>
                ...
                <th scope="col">Cantidad Cuentas</th>
