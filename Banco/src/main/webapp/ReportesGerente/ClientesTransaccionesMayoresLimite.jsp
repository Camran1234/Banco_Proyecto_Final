<%-- 
    Document   : ClientesTransaccionesMayoresLimite
    Created on : Nov 14, 2020, 5:51:43 AM
    Author     : camran1234
--%>
                        ...
                        <div  class="card">
                            <div class="card-body">
                                <div class="card-title">
                                    <h2 class="text-center" id="text" >Clientes con Transacciones Mayores Al Monto Permitido por Transacción Monetaria Individual</h2>
                                         <h5 class="text-center" id="text" >Monto Permitido Q<%=new InfoMonto().obtenerMontoSolitario()%></h5>
                                </div>
                                <hr>
                                <form method="post" action="../GerenteTransaccionesLimite">
                                ...
                                <form method="post" action="../Exportar">
                                    ...
                                    <input type="hidden" name="Monto" value="<%=new InfoMonto().obtenerMontoSolitario()%>">
                                    <input type="hidden" name="url" value="ClientesTransaccionesMayoresLimite">
                                    <input type="hidden" name="urlCompleta" value="./ReportesGerente/ClientesTransaccionesMayoresLimite.jsp">
