<%-- 
    Document   : TransaccionesIntervaloTIempo
    Created on : Nov 14, 2020, 2:03:23 AM
    Author     : camran1234
--%>
                        ...
                        <div  class="card">
                            <div class="card-body">
                                <div class="card-title">
                                    <h2 class="text-center" id="text" >Transacciones Realizadas en un Intervalo de Tiempo</h2>
                                ...
                                <hr>
                                <form method="post" action="../TransaccionesIntervaloTiempo">
                                    <div class="row">
                                        <div class="col-6">
                                ...
                                <form method="post" action="../Exportar">
                                    ...
                                    <input type="hidden" name="url" value="TransaccionIntervaloTiempoCliente">
                                    <input type="hidden" name="urlCompleta" value="./ReportesCliente/TransaccionesIntervaloTiempo.jsp">
