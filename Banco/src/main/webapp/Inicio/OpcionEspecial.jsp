<%-- 
    Document   : OpcionEspecial
    Created on : Nov 8, 2020, 11:38:14 PM
    Author     : camran1234
--%>
...
<body>
    ...
    <form method="get" action="../Inicio/CargaArchivo.jsp">
        <div class="container" >
                <div class="row justify-content-center">
                <div class="form-group col-md-4 col-md-offset-4 align-center ">
                        <label id="formsText">Opciones Especiales</label><br>
                        <span></span>
                        <label id="TittleText">Codigo</label>
